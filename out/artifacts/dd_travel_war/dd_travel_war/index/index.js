...
function getAdbLine(type) {
    $.ajax({
        type: "get",
        url: "http://localhost:8080/dd_travel_war/adb",
        data: {
            method: "indexLineAdb",
            lineType:type
        },
                ...
                if (data.notasideAdb.length > 0) {
                    $(data.notasideAdb).each(function (index, item) {
                        ...
                        ins +=
                            ...
                            '<a href="/line-detail/line-detail.html?id='+item.travel_id+'" class="tt" style="text-decoration:none;">' +
...
function searchLine() {
    ...
    window.location.href = 'http://localhost:8080/dd_travel_war/line-list/line-list.html?key=' + value;
